...
def remove_clones(customer_ids):  # create value of remove
    similar_ids = set(customer_ids)  # create set() to remove duplicates
    return similar_ids  # return 

similar_ids = remove_clones(customer_ids)
